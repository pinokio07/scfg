...
<body>
  ...
  <table class="table table-bordered" style="border-collapse: collapse;">
    <tr>
      <td colspan="2" class="text-right h5" style="padding-top: 1mm;padding-right:1mm;padding-bottom:0px;">
        @php
    ...
    <tr>
      <td colspan="2" class="text-center h10 f16 bold">
        <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($house->NO_BARANG, 'C128', 1, 25, array(0, 0, 0))}}" alt="barcode" style="width:90% !important;" /><br>
        {{ $house->NO_BARANG ?? "-" }}
      </td>
    ...
    <tr>
      <td class="h3 f7" style="border-bottom: none !important;">
        MASTER AIRWAY BILL No.
      </td>
      <td rowspan="2" 
          style="padding-top: 3mm;border-bottom: none !important;" 
          class="text-center f7">
        TOTAL <br> No. OF PIECES        
      </td>
    </tr>
    <tr>
      <td class="f8 text-center bold" style="border-top: none !important;">
        {{ $house->mawb_parse ?? "-" }}
      </td>
    </tr>
    <tr>
      ...
      <td rowspan="2" class="text-center f8 bold" style="border-top: none !important;">
        {{ $house->JML_BRG ?? 0 }}
      </td>
    </tr>
    <tr>
      ...
      <td rowspan="4" style="padding: 0.75em;text-align:center;">
